...
Use this skill for repository quality work in `jooservices/laravel-events`.

Required behavior:

- inspect the real repository first
- clean local work before new tasks
- resolve or report open PR and branch sync blockers
- keep `master` production-ready and `develop` development-ready
